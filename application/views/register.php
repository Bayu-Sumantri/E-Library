...
<form action="proses.php" method="post">
    ...
    <br>
    <div class="login">
        <input type="text" placeholder="nama lengkap" name="nama_user" required><br>
        ...
        <div class="register" style="margin-right: 100px;">
          ...
          <div style="text-align: center;"><a class="hoverlink" href="" style="text-align: center;">Login Here</a></div>
        </div>
